						...
						success : function(customers) {
							...
							if (size > 0) {
								customers.forEach(function(customer, idx) {
									...
									data += '<img src="http://192.168.0.115/storage/customer/'+customer.receive.customerNo+'.jpg"';
							...
							if (size > 0) {
								projects
										.forEach(function(project, index) {
											...
											data += '<div class="test">';
											data += '<img src="http://192.168.0.115/storage/recruit/img/'+project.recruit.recruitNo+'.jpg"';
