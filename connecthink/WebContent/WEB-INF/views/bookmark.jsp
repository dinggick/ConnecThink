...
<body>
	...
	<div class="featured_candidates_area candidate_page_padding">
		<div class="container">
			<div class="row">
				<div class="col-md-12 col-lg-12 bookMenu ml-3">
					<button class="genric-btn default radius mate_tab" style="background: #fff" onclick="mtab();">메이트</button>
					<button class="genric-btn default radius team_tab" onclick="ttab();">팀</button>
				</div>
			</div>
			<!-- 메이트 -->
		...
		function mtab(){
			document.querySelector(".mate").style.display="block";
			document.querySelector(".team").style.display="none";
			document.querySelector(".mate_tab").style.background="#fff";
			document.querySelector(".team_tab").style.background="#f9f9ff";
		}
