								...
								<div class="col-12 content">
									<div class="msg_header">
										<div class="msg_sender">
											<img src="img/person.png"><span class="otherNo"
...
function fxLoadNoti(customerNo){
	$.ajax({
		...
		,success:function(noties){
			let otherData = '<img src="img/person.png"><span class="otherNo" id="otherNoInBox">0</span><span class="personName">컨넥띵크</span>';
			let sectionData = "";
