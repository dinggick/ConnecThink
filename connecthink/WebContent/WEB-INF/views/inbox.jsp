                    			...
                    			<div class="col-12 content">
                    			    <div class="msg_header">
                    					<div class="msg_sender">
                    						<img src="${contextPath}/img/person.png"><span class="customerNo"></span><span class="personName">고디바</span>
                    					</div>
                    				</div>
                    				<div class="msg_body">
...
function fxLoadMSGs(customerNo, otherNo){
	$.ajax({
		...
		,success:function(MSGs){
			let otherData = "";
			otherData += '<img src="${contextPath}/img/person.png"><span class="customerNo">' + otherNo + '</span>';
